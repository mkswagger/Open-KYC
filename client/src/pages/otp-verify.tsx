        ...
        <div className="flex flex-col gap-5 w-1/3 mx-auto justify-center min-h-screen">
            <Form {...emailform}>
                ...
                <div className="flex justify-between">
                    <Button onClick={emailform.handleSubmit(onEmailSubmit)}>Verify</Button>
                    <Button onClick={emailform.handleSubmit(onEmailSubmit)}>Resend OTP</Button>
                </div>
            </Form>
            <Form {...phoneform}>
                <FormField
                ...
                <FormMessage />
                <div className="flex justify-between">
                    <Button onClick={phoneform.handleSubmit(onPhoneSubmit)}>Verify</Button>
                    <Button onClick={phoneform.handleSubmit(onPhoneSubmit)}>Resend OTP</Button>
                </div>
            </Form>
