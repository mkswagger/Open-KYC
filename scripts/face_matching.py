...
def compare_faces(live_image_path):
    ...
    live_embedding = DeepFace.represent(img_path=live_image_path, model_name="VGG-Face") #must delete "24-03-13 20:48:40 - Directory /Users/aryanraj/.deepface created"
